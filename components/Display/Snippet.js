...
const Snippet = ({myCodeSnippets, loading, allOpenStates, setAllOpenStates, handleDelete, isEmpty, fetchMore}) => {
  return (
    <div>
                              ...
                              <div className="flex items-center justify-between w-full MonoHeading">
                                <div className="flex gap-2">
                                  ...
                                  {snip.folder?.language?.acc?.accId && (
                                    <div
                                      className={`${snip.folder?.langauge?.acc?.classTree} lBadge rounded-3xl flex justify-center items-center`}
                                    >
                                      <p className="text-xs MonoHeading font-semibold lowercase">
